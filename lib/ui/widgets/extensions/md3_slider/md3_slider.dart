...
import 'md3_slider_thumb.dart';
import 'squiggly_slider_track_shape.dart';

class Material3Slider extends StatefulWidget {
  const Material3Slider({
    required this.value,
  ...
  @override
  State<Material3Slider> createState() => _Material3SliderState();
}

class _Material3SliderState extends State<Material3Slider> with SingleTickerProviderStateMixin {
